...
def convnet_cifar10(debug_output=False, data_path=data_path, epoch_size=8, minibatch_size=4, max_epochs=30):
    ...
    lr_per_sample          = [0.0015625]*3 + [0.00046875]*3 + [0.00015625]
